...
```json
{
  ...
  "data": {
    ...
    "model": "sonnet",
    "task_summary": "Create ProductCard component",
    "complexity": "simple",
...
## Overview
- Task: Add user favorites feature
- Complexity: Moderate
- Duration: 12m 34s
- Status: COMPLETED
...
|-------|-------|----------|--------|
| backend-specialist | 15 | 4m 12s | Success |
| frontend-specialist | 18 | 5m 45s | Success |
| test-specialist | 12 | 2m 15s | Success |
| code-reviewer | 4 | 22s | Success |
