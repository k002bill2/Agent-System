...
```json
{
  ...
  "state": {
    ...
    "active_agents": ["frontend-specialist"],
    "blocked_agents": [],
    "findings_count": 3
  },
  "context_summary": "Implementing user profile feature. UI components done, backend integration in progress.",
  "next_action": "Wait for backend-specialist to complete API service",
...
1. Create research plan
   .temp/memory/research_plans/user_feature.md

2. After exploration phase
   .temp/memory/checkpoints/cp_exploration_*.json
   .temp/memory/findings/exploration_*.md

3. After spawning frontend + backend agents
   .temp/memory/findings/frontend_*.md
   .temp/memory/findings/backend_*.md
