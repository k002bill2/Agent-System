        ...
        <div className="flex-1 flex flex-col gap-4 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <textarea
              ...
              className={cn(
                'flex-1 min-h-[80px] px-3 py-2 bg-gray-50 dark:bg-gray-900 border rounded-lg text-sm text-gray-900 dark:text-white resize-none focus:outline-none focus:ring-2 focus:ring-primary-500',
