...
## Current Position
**2026-08-27 기준 — main `d32e465`. 열린 PR 0 건.**

| 항목 | 상태 |
|---|---|
| 열린 PR | **0 건** (#322 `bd08396` · #317 `e968dd7` · #325 `0dc4a8e` · #327 `d32e465` 전부 squash 머지) |
| 열린 이슈 | **#330** 리콘실러가 채운 컬럼의 FK 제약 미복구 — **착수 전 설계·실측이 이슈 코멘트에 있다. 다시 하지 말 것** · **#329** 대시보드가 세션 403 을 조용히 삼킴 |
